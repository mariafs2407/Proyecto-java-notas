<%-- 
    Document   : nuevo
    Created on : 27 oct. 2022, 20:18:41
    Author     : maria
--%>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card card-primary mt-3">
                    ...
                    <div class="card-body">                        
                        ...
                        <form id="form_regcli" action="${URL_APLICACION}/admin/clientes/registrar" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombres_apellidos" name="nombres_apellidos" placeholder="Ingrese nombres">
                            </div>                            
